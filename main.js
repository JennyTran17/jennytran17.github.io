...
window.openProjectModal = function(projectId) {
    ...
    const projects = {
        'game1': {
            title: 'RoboQuest',
            description: 'An immersive 2D adventure game built with Unity, featuring dynamic lighting, physics-based gameplay, and an engaging storyline.',
            tech: ['Unity', 'C#', '2D Graphics', 'Physics']
        },
        'game2': {
            title: 'DinoScape',
            description: 'A physics game about a dinosaur trying to escape the falling galaxy, advanced physics simulation, and dynamic physic interactions',
            tech: ['Unity', 'C#', 'Physics']
        },
        'game3': {
            title: 'Shadow Survival Puzzle Game',
            description: 'An addictive mobile puzzle game with intuitive PC and PS4 controls, and progressive difficulty levels.',
            tech: ['Unity', 'C#', 'Controller', '2D Graphics', 'AutoGenerated Level']
        },
        'web1': {
        ...
        'web2': {
            ...
            description: 'A voice assistant with natural language processing, speech recognition, and text-to-speech capabilities.',
