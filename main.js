...
window.openProjectModal = function(projectId) {
    ...
    const projects = {
        'game1': {
            ...
            description: 'An immersive 3D adventure game built with Unity, featuring dynamic lighting, physics-based gameplay, and an engaging storyline.',
            tech: ['Unity', 'C#', '3D Graphics', 'Physics']
        },
        'game2': {
            title: 'Multiplayer Racing Game',
            description: 'A competitive multiplayer racing game with real-time networking, advanced physics simulation, and dynamic weather effects.',
            tech: ['Unreal Engine', 'C++', 'Networking', 'VR']
        },
        'game3': {
            title: 'Mobile Puzzle Game',
            description: 'An addictive mobile puzzle game with intuitive touch controls, beautiful animations, and progressive difficulty levels.',
            tech: ['Unity', 'C#', 'Mobile', '2D Graphics']
        },
        'web1': {
            title: 'E-Commerce Platform',
            description: 'A full-stack e-commerce solution with React frontend, Node.js backend, and advanced features like real-time inventory and payment processing.',
            tech: ['React', 'Node.js', 'MongoDB', 'AWS']
        },
        'web2': {
            title: 'Data Visualization Dashboard',
            description: 'An interactive dashboard for data analysis with D3.js visualizations, real-time updates, and comprehensive reporting tools.',
            tech: ['D3.js', 'Python', 'Flask', 'PostgreSQL']
        },
        'web3': {
            title: 'Social Media App',
            description: 'A modern social media application with real-time messaging, photo sharing, and advanced user authentication features.',
